            ...
            <div className="row no-gutters">
                ...
                <div className="col-9">
                    <div className="card-block px-2" style={{ textAlign: 'left' }}>
                        ...
                        <button value={item?.quantity} onClick={e => handleQuantityAdd(e.target.value)}>+</button>
                        <button value={item?.quantity} onClick={e => handleQuantitySubtract(e.target.value)}>-</button>
